...
class ChineseMarket:public Market{
protected: ChineseMarket(std::string symbol,Currency c,long mo,long mc);
};
...
// Concrete subclasses:
class ShenZhenMarket:public ChineseMarket{
    public:ShenZhenMarket(std::string symbol);
};
